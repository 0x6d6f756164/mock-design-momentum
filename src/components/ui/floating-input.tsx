    ...
    return (
      <div className="relative">
        <input
          ...
          placeholder=" "
          className={cn(
            "peer h-14 w-full rounded-md border border-paper/15 bg-paper px-3 pb-2 pt-6 text-sm text-ink outline-none focus-visible:ring-[3px] focus-visible:ring-cobalt/30",
            error && "border-cobalt",
            className
          )}
          {...props}
